...
export const activities: Activity[] = [
  {
    ...
    operatorId: "00000000-0000-0000-0000-000000000100",
  ...
  },
  {
    ...
    basePrice: 2500,
    isActive: true,
    includes: ["Guide", "Gear", "Lunch", "Transport", "Insurance"],
    rating: 4.90,
    reviewCount: 218,
    elevation: "4,390m",
  },
...
export const bookings: Booking[] = [
  {
    ...
    slotId: "slot-1",
    activityId: "00000000-0000-0000-0000-000000000200",
    groupSize: 2,
    subtotal: 3000,
    taxes: 540,
    total: 3540,
  ...
  },
  {
    ...
    userId: "00000000-0000-0000-0000-000000000004",
    slotId: "slot-49",
    activityId: "00000000-0000-0000-0000-000000000203",
    groupSize: 1,
    subtotal: 1200,
    taxes: 216,
    total: 1416,
  ...
  },
  {
    ...
    userId: "00000000-0000-0000-0000-000000000004",
    slotId: "slot-25",
    activityId: "00000000-0000-0000-0000-000000000202",
    groupSize: 3,
    subtotal: 7500,
    taxes: 1350,
    total: 8850,
...
export const incidents: Incident[] = [
  ...
  },
  {
    ...
    operatorId: "00000000-0000-0000-0000-000000000100",
    activityId: "00000000-0000-0000-0000-000000000200",
    reportedBy: "00000000-0000-0000-0000-000000000010",
  ...
  {
    id: "inc-003",
    operatorId: "00000000-0000-0000-0000-000000000103",
    reportedBy: "00000000-0000-0000-0000-000000000001",
